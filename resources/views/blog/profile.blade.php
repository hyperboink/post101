		...
		<div class="col-md-3 profile-panel">
			...
			<div class="card">
				<div class="card-img-wrap">
					<img class="card-img-top" src="/images/hypermonsta.svg" alt="Card image cap">
				</div>
							...
							<div class="post-body-title clearfix">
								<div class="post-title-con">
									...
									<div class="post-details">
										...
										</a> by <a class="posted-by" href="profile/{{Auth::user()->id === $post->user_id ? '' :  $post->user->name}}">{{Auth::user()->id === $post->user_id ? 'You' :  $post->user->name}}</a>
										@if($post->isEdited())
			...
			<form class="post-form">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="text" name="title" placeholder="Title here..." class="form-control modal-form-input modal-input-title" value="asffsd">
						<span class="error validation-text text-danger"></span>
					</div>
					<div class="form-group">
						<textarea class="form-control modal-form-input modal-input-content" name="content" placeholder="Content here..." rows="6">sadfdsfsf</textarea>
						<span class="error validation-text text-danger"></span>
					</div> 
				</div>
